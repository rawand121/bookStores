const englishTranslate = {
  ...
  footerDescription:
    "'my books' project is a project that you can get benefits from it as the biggest Kurdish source that you can order a book from any Libraries that have participated in this project. It is free to deliver the books to you, and we will take responsibility for them. You can exchange your books for someone else or put them for sale to let people get benefits from them.",
  username: "username",
  ...
  exchangeDescription:
    "You can see the books that someone added to exchange them for another book. Also you can add yours to here",
  sellDescription:
    "You see the books that someone wants to sell, and you can buy any books you want. Also you can add yours to here the used books.",
  sellTitle: "Sell",
  booksTitle: "See All Books",
  booksDescription:
    "You can see all the books that the Bookstores added, and you can buy the new books as much as you want",
